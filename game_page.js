...
function send(){
    ...
    length_two=Math.floor(word.length/2)
    charAt2=word.charAt(length_two)
    console.log(charAt2)

    length_min1=word.length-1
    CharAt3=word.charAt(length_min1)
    console.log(CharAt3)
...
function check(){
    ...
    console.log("The Answer You Have Typed is = " + answer)
